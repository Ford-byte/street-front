<template>
  <div>
    ...
    >
          ...
          <tbody>
            ...
            >
              ...
              <td class="py-3 px-4 flex">
                ...
                <button
                  @click.stop="confirmDelete(product.SW_Id)"
      ...
      >
        ...
        >
          ...
          <div class="flex justify-center text-xs">
            <button
              @click="goToPage(paginateCurrentPage - 1)"
            ...
            <span class="px-4 py-2"
              >{{ paginateCurrentPage }} / {{ paginateTotalPages }}</span
            >
            <button
              @click="goToPage(paginateCurrentPage + 1)"
      ...
      >
        <div
          class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md mx-auto mt-24"
        >
                ...
                <div>
                  <label class="inline-flex items-center mx-2">
                    <input
                      ...
                      v-model="stockSmall"
                      placeholder="Small"
                      class="w-16 p-2 border border-black rounded-md"
                    />
                  </label>
                  <label class="inline-flex items-center mx-2">
                    <input
                      ...
                      v-model="stockMedium"
                      placeholder="Medium"
                      class="w-20 p-2 border border-black rounded-md"
                    />
                  </label>
                  <label class="inline-flex items-center mx-2">
                    <input
                  ...
                  <label class="inline-flex items-center mx-2">
                    <input
                      ...
                      class="w-24 p-2 border border-black rounded-md"
                    />
                  </label>
                </div>
              </div>
          ...
          <div v-else>
            ...
            <form @submit.prevent="updateProduct()">
              ...
              <div class="mb-4">
                <label class="block text-gray-700">Name</label>
                <input
                  v-model="currentProduct.SW_Name"
                  type="text"
                  class="w-full border border-gray-300 p-2 rounded-md"
                  required
                />
              ...
              <div class="mb-4">
                <label class="block text-gray-700">Price</label>
                <input
                  v-model="currentProduct.SW_Price"
                  type="number"
                  class="w-full border border-gray-300 p-2 rounded-md"
                  required
                />
              ...
              <div class="mb-4">
                ...
                <div class="">
                  <label class="inline-flex items-center mx-2">
                    <input
                      type="number"
                      v-model="currentProduct.SW_Small"
                      class="w-16 p-2 border border-black rounded-md"
                    />
                  </label>
                  <label class="inline-flex items-center mx-2">
                    <input
                      type="number"
                      v-model="currentProduct.SW_Medium"
                      class="w-20 p-2 border border-black rounded-md"
                    />
                  </label>
                  <label class="inline-flex items-center mx-2">
                    <input
                      type="number"
                      v-model="currentProduct.SW_Large"
                      class="w-16 p-2 border border-black rounded-md"
                    />
                  </label>
                  <label class="inline-flex items-center mx-2">
                    <input
                      type="number"
                      v-model="currentProduct.SW_X_large"
                      class="w-24 p-2 border border-black rounded-md"
                    />
                  </label>
                </div>
              ...
              <div class="mb-4">
                ...
                <label class="inline-flex items-center mx-2">
                  <input
                    type="radio"
                    v-model="currentProduct.SW_Category"
                    value="shorts"
                    class="form-radio"
                  />
                  <span class="ml-2">Shorts</span>
    ...
    <ConfirmationModal
      ...
      @confirm="deleteProduct(userIdToDelete)"
